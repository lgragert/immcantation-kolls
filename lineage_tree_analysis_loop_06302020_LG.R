...
# SECTION 1: read BCR file and process the data ***this currently only works for one BCR file at a time***


# read BCR file
BCRE1 <- read.csv ("./irepertoire_fasta/BCRE1_CATGTC_primers-pass_igblast_db-pass_clone-pass_germ-pass_airr.tsv",sep="\t")
# BCRE2 <- read.csv ("./irepertoire_fasta/BCRE2_TGTATC_primers-pass_igblast_db-pass_clone-pass_germ-pass_airr.tsv",sep="\t")
...
# SECTION 2: make lineage tree plots for each data set
...
# SECTION 3: ***this part is still in progress***

# create data frame

BCRE_files <- dir(path="./irepertoire_fasta/", pattern="*airr.tsv", full.names=TRUE, recursive=FALSE)
